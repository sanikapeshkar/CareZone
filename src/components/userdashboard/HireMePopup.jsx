        ...
        <div className='w-screen h-screen fixed flex justify-center items-center bg-gray-50/50'>
            <div ref={popupRef} className='bg-white p-4 border-2 border-[#d3d9dd] rounded-2xl flex flex-col w-[400px]'>
                <div className='flex justify-between items-center'>
                    ...
                    <img className='h-6 w-6 cursor-pointer' src={cross} onClick={onClose} alt="Close"></img>
                </div>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className='flex justify-between items-center w-full'>
                        <h1 className='text-xl w-1/2'>Date</h1>
                        <div className="scale-75 ml-auto">
                            <BasicDatePicker {...register('date', { required: 'Date is required' })} />
                        </div>
                    ...
                    <div className='flex justify-between items-center w-full'>
                        ...
                        <div className="scale-75">
                            <BasicTimePicker {...register('time', { required: 'Time is required' })} />
                        </div>
                    ...
                    <div className='w-1/2 ml-auto flex justify-end mt-2'>
                        <button type='submit' className='ml-auto bg-[#8883f0] p-2 px-3 rounded-2 text-white'>Submit</button>
                    </div>
                </form>
            </div>
        </div>
